...
//volatile crsfPayloadLinkstatistics_s CRSF::LinkStatistics;  //повтор
...
//uint8_t CRSF::CRSFoutBuffer[CRSF_MAX_PACKET_LEN] = {0}; //Отличается у старой библиотеки, оставлена старая
...
////  Конец добавления из новой библиотеки
///////////////////////////////////////////////////////////////
